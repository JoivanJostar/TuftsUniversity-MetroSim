...
/// <summary>
/// test MetroSim Constructor. It will need 2 arguments:
/// ifstream stationsFile : the input stations file
/// ofstream outFile : the output log file
/// here i use the given statons.txt as the test file 
/// assuming that the station.txt is exists.
/// </summary>
void testMetroSimConstructor() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open()&& outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
	}

}

/// <summary>
///  test MetroSim printStateInfo()
/// here I create a local simulator for test.
/// </summary>
void testMetroSimPrintStateInfo() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
...
/// <summary>
/// test MetroSim move()
/// a temp local simulator is used.
/// </summary>
void testMetroSimMove() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
...
/// <summary>
/// test AddPassenger(id,from,to)
/// </summary>
void testMetroSimAddPassenger() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
		sim.addPassenger(1, 2, 3);
		sim.printStateInfo();
	}
}
/// <summary>
/// test the addPassenger(id,from,to)
/// where the argument from is negative.
/// </summary>
void testMetroSimAddPassengerWithWrongNum1() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
...
/// <summary>
/// test the addPassenger(id,from,to)
/// where the argument to is negative.
/// </summary>
void testMetroSimAddPassengerWithWrongNum2() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
		sim.addPassenger(1, 2, -1);
		sim.printStateInfo();
	}
}

/// <summary>
/// test execute command, p from to
/// </summary>
void testMetroSimExectue1() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
		sim.executeCommmand("p 1 2");
		sim.executeCommmand("p 2 3");
		sim.printStateInfo();
	}
}

/// <summary>
/// test execute command, "m m"
/// </summary>
void testMetroSimExectue2() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
...
/// <summary>
/// test execute except command
/// </summary>
void testMetroSimExectue3() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
		sim.executeCommmand("2313414asdf");
	}
}

/// <summary>
/// test execute command, "m f"
/// </summary>
void testMetroSimExectue4() {
	std::ifstream stationsFile("stations.txt");
	std::ofstream outFile("out.txt");
	if (stationsFile.is_open() && outFile.is_open()) {
		MetroSim sim = MetroSim(stationsFile, outFile);
		sim.executeCommmand("m f");
	}
}